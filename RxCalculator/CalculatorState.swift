...
extension CalculatorState {
    fileprivate func addNumber(_ char: Character) -> CalculatorState {
    ...
    fileprivate func addDot() -> CalculatorState {
        let cn = inScreen.range(of: ".") == nil ? currentNumber + "." : currentNumber
        return CalculatorState(previousNumber: previousNumber, action: action, currentNumber: cn, inScreen: cn!, replace: false)
    }
    
    fileprivate func performOperation(_ o: Operator) -> CalculatorState {
    ...
    fileprivate func performEqual() -> CalculatorState {
